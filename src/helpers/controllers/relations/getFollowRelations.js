...
const getFollowRelations = (user_id, follows_id, accepted, mysqlClient) => {
  return new Promise((resolve, reject) => {
    ...
    WHERE FollowRelations.user = ? AND FollowRelations.accepted = ?`, [user_id, follows_id, accepted ? 1 : 0], (err, result) => {
