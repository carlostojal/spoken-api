...
const getFeed = (page, perPage, user_id, mysqlPool) => {
  return new Promise(async (resolve, reject) => {
    ...
    mysqlPool.getConnection((err, connection) => {
      ...
      connection.query(`SELECT CurrentPost.id, CurrentPost.time, CurrentPost.text, CurrentPost.media_id, CurrentPost.edited, (SELECT COUNT(*) FROM PostReactions WHERE post_id = CurrentPost.id AND user_id = ?) AS user_reacted,
