...
const getCommentsByPostId = (post_id, page, perPage, mysqlPool) => {
  return new Promise(async (resolve, reject) => {
    ...
    mysqlPool.getConnection((err, connection) => {
      ...
      connection.query(`SELECT CurrentPost.id, CurrentPost.time, CurrentPost.text, CurrentPost.media_id, CurrentPost.edited,
