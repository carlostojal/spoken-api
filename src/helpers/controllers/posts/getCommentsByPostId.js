...
const getCommentsByPostId = (post_id, page, perPage, mysqlClient) => {
  return new Promise((resolve, reject) => {
    mysqlClient.query(`SELECT CurrentPost.id, CurrentPost.time, CurrentPost.text, CurrentPost.media_id, CurrentPost.edited, 
      ...
      Users.id AS poster_id, Users.name AS poster_name, Users.surname AS poster_surname, Users.username AS poster_username, Users.profile_pic_media_id 
      Media.is_nsfw AS is_nsfw, Media.nsfw_cause AS nsfw_cause
      FROM Posts CurrentPost INNER JOIN Users ON CurrentPost.user_id = Users.id 
      ...
      LEFT JOIN Media ON CurrentPost.media_id = Media.id
